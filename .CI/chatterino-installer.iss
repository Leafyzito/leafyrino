...
#define STAGING_DIR_NAME "Leafyrino7"
#endif
...
#else
OutputBaseFilename=Leafyrino7.Installer
#endif
...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "Leafyzito.Leafyrino7"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "Leafyzito.Leafyrino7"; Tasks: desktopicon
