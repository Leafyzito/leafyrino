...
#define MyAppName "Moltorino7"
#define MyAppVersion "7.5.5"
#define MyAppPublisher "MoltoBenne"
#define MyAppURL "https://github.com/MoltoBenne/Moltorino"
#define MyAppExeName "Moltorino7.exe"
#define MyAppProductName "Moltorino"
#define MyAppDescription "Moltorino Installer"
#define MyAppCopyright "Copyright (C) MoltoBenne"
...
#define STAGING_DIR_NAME "Moltorino7"
#endif
...
VersionInfoOriginalFileName=Moltorino Updater.exe
...
#else
OutputBaseFilename=Moltorino7.Installer
#endif
...
[Icons]
Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "MoltoBenne.Moltorino7"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; AppUserModelID: "MoltoBenne.Moltorino7"; Tasks: desktopicon
